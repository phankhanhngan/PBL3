...
//        birthdayDatePicker.setValue(LocalDate.now());
    ...
    public void loadTable(String txt) {
        ...
        try {
            ...
            while(queryResult.next()) {
                ...
                Customer customer = new Customer(ID, firstname, lastname, gmail, phone, gender, birthday);
                list.add(customer);
            }
    ...
    public void Update()
    {
        try {
            ...
            this.update.setInt(7,((Customer)CustomerTableView.getSelectionModel().getSelectedItem()).getID());
