...
public class CustomerController implements Initializable {
    ...
    public void Delete() {
        ...
        if (alert.getResult() == ButtonType.YES) {
            if (BLLCustomers.DeleteCustomer(CustomerTableView.getSelectionModel().getSelectedItem().getID())) {
                ...
                Notifications.create().text("You have failed to delete this customer!").title("Oh Snap!")
                        .hideAfter(Duration.seconds(5.0D)).show();
            }
        }
    }
    ...
    public void Update() {
        ...
        if (BLLCustomers.UpdateCustomer(c)) {
            ...
            Notifications.create().text("You have failed to update customer into our System. Try again!").title("Oh Snap!")
                    .hideAfter(Duration.seconds(5.0D)).show();
        }
    }
